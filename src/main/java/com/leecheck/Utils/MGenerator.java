...
public class MGenerator {
    ...
    private static void shell(String tableName) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/admin_db?characterEncoding=utf8");
        mpg.setDataSource(dsc);*/

        dsc.setDbType(DbType.SQL_SERVER);
        dsc.setDriverName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        dsc.setUsername("sa");
        dsc.setPassword("ltgkwang123");
        dsc.setUrl("jdbc:sqlserver://192.168.1.113:1433;DatabaseName=main;integratedSecurity=false");
        mpg.setDataSource(dsc);
...
//         strategy.setSuperEntityClass("com.baomidou.demo.TestEntity");
        ...
        pc.setEntity("entity.main");
        pc.setMapper("mapper.main");
        pc.setXml("xml");
